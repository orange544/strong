...
ensureIndex(dbRef.teaching_materials, { course_code: 1 });
ensureIndex(dbRef.student_growth_archive, { student_id: 1 });

print('School A MongoDB schema initialized: university_document_db');
