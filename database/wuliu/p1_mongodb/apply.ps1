...
$schemaFile = Join-Path $PSScriptRoot 'p1_mongodb.js'
$sampleFile = Join-Path $PSScriptRoot 'p1_mongodb_sample_data.js'
if (-not (Test-Path $schemaFile)) {
  throw 'P1 MongoDB schema file not found.'
}
if (-not (Test-Path $sampleFile)) {
  throw 'P1 MongoDB sample data file not found.'
}
...
Write-Host 'P1 MongoDB schema and sample data initialized: wuliu_p1_mongodb_db'
