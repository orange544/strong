...
$cqlFile = Join-Path $PSScriptRoot 't1_cassandra.cql'
...
if ($LASTEXITCODE -ne 0) {
  throw 'T1 Cassandra initialization failed.'
}

Write-Host 'T1 Cassandra schema and sample data initialized: wuliu_t1_cassandra_ks'
